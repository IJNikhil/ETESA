...
public class FacultyMarkReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_faculty_mark_report);
        ...
        if (next == null) {
            ...
            next.setOnClickListener(view -> {
                ...
                if (selectedClass.isEmpty() || selectedSemester.isEmpty() || selectedSubject.isEmpty() || selectedDate.isEmpty()) {
                    Toast.makeText(FacultyMarkReportActivity.this, "Please select all fields", Toast.LENGTH_SHORT).show();
                } else {
                    // Navigate to MarkAbsentActivity
                    Intent intent = new Intent(getApplicationContext(), MarkAbsentActivity.class);
    ...
    private void initViews() {
        ...
        selectDate.setOnClickListener(v -> {
            ...
            DatePickerDialog datePickerDialog = new DatePickerDialog(
                    FacultyMarkReportActivity.this,
